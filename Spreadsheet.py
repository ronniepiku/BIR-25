...
def spreadsheet(file_name):
    ...
    with open('investment_results_2023.txt', 'w') as txtfile:
    ...
    if platform.system() == 'Darwin':  # macOS
        subprocess.run(['open', 'investment_results_2023.txt'])
    elif platform.system() == 'Windows':  # Windows
        subprocess.run(['start', 'investment_results_2023.txt'], shell=True)
    elif platform.system() == 'Linux':  # Linux
        subprocess.run(['xdg-open', 'investment_results_2023.txt'])
    else:
